...
import { ProductCatalogueSection } from '@/modules/admin/components/ProductCatalogueSection';
import { ProductVariantsSection } from '@/modules/admin/components/ProductVariantsSection';
import { ProductImageConfigurator } from '@/modules/admin/components/ProductImageConfigurator';
import { ProductGallerySection } from '@/modules/admin/components/ProductGallerySection';
import { ShippingPackagingSection } from '@/modules/admin/components/ShippingPackagingSection';
import { ProductPricingSection } from '@/modules/admin/components/ProductPricingSection';
import { ProductStocksSection } from '@/modules/admin/components/ProductStocksSection';
import { ProductOptionsSection } from '@/modules/admin/components/ProductOptionsSection';
import { ProductDetailsSection } from '@/modules/admin/components/ProductDetailsSection';
import { UploadMockupsSection } from '@/modules/admin/components/UploadMockupsSection';
import {
  ProductFormData,
