...
import { ProductCatalogueData } from '@/shared/types/product';
import { CATEGORIES, CategoryId, getSubcategories, generateProductTypeCode } from '@/shared/config/productCategories';
