...
import type { CanvasElement, Product, ProductView } from '@/shared/types/editor';
import type { DisplacementSettings, DesignPlacement } from '@/shared/types/product';
import type { PrintMethodId } from '@/shared/config/printMethods';
