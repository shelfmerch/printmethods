...
import StorefrontHomePage from '@/storefront/pages/StorefrontHomePage';
import StoreProductsPage from '@/storefront/pages/StoreProductsPage';
...
import StoreAuthPage from '@/storefront/pages/StoreAuthPage';
import StoreProfilePage from '@/storefront/pages/StoreProfilePage';
import StoreOrdersPage from '@/storefront/pages/StoreOrdersPage';
import StoreSettingsPage from '@/storefront/pages/StoreSettingsPage';
import StoreOrderDetailPage from '@/storefront/pages/StoreOrderDetailPage';
