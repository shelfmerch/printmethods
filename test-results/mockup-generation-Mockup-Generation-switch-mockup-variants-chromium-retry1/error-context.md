...
- Name: mockup-generation.spec.ts >> Mockup Generation >> switch mockup variants
- Location: e2e\mockup-generation.spec.ts:13:3
...
Call log:
  - waiting for locator('[data-testid="variant-black"]')
