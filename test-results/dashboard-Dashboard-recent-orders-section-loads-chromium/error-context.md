...
- Name: dashboard.spec.ts >> Dashboard >> recent orders section loads
- Location: e2e\dashboard.spec.ts:13:3
...
Locator: locator('[data-testid="recent-orders"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="recent-orders"]')
