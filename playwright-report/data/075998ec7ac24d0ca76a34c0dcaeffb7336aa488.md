...
- Name: order-management.spec.ts >> Order Management >> orders table loads
- Location: e2e\order-management.spec.ts:5:3
...
Locator: locator('[data-testid="orders-table"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="orders-table"]')
