...
?>
<div class="modal fade" id="dg-myclipart" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><?php echo lang('designer_upload_upload_btn'); ?></h4>
				<a href="javascript:void(0)" class="close" data-dismiss="modal"><i class="glyph-icon flaticon-cross flaticon-14"></i></a>
			</div>
			<ul role="tablist" id="upload-tabs">
				<li class="active">
					<a href="#upload-conputer" class="bg-upload-conputer" role="tab" data-toggle="tab">
						<i class="fa fa-laptop" aria-hidden="true"></i>
						<span><?php echo lang('designer_upload_upload_photo'); ?></span>
					</a>
				</li>
				<?php $addons->view('upload-label', array(), 'editor'); ?>
			</ul>
