...
<div class="tool-header text-center">
	...
	<div class="toolbar-left">
		<ul class="header-menu pull-left">
			<li class="hidden-sm hidden-xs menu-item-home"><a href="#dg-help">Home</a></li>
			...
			<li class="hidden-sm hidden-xs menu-item-help"><a href="#dg-help" data-toggle="modal" data-target="#dg-help"><?php echo lang('design_guideline_help'); ?></a></li>
		</ul>
	</div>
