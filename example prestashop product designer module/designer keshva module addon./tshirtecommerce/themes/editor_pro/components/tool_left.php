		...
		<div class="dg-box width-100">
			<ul class="menu-left">
				...
				<li <?php echo cssShow($settings, 'show_add_art'); ?> class="menu-item-clipart" onclick="menu_options.show('cliparts');">
					<a href="javascript:void(0);" class="dg-tooltip" data-placement="<?php echo $tooltip[$layout]; ?>" data-placement="<?php echo $tooltip[$layout]; ?>" title="<?php echo lang('designer_menu_add_art'); ?>">
