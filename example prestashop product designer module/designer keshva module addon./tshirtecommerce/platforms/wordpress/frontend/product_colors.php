...
class P9f_products_colors
{
	...
	public function init()
	{
		...
		if (extension_loaded('gd') && function_exists('gd_info')) 
		{
			...
			add_action( 'woocommerce_after_shop_loop_item_title', array($this, 'show_colors'), 5 );
	...
	public function addjs()
	{
		...
		if(is_shop())
		{
			wp_enqueue_script( 'tshirtecommerce_colors', network_site_url( 'tshirtecommerce/platforms/assets/product_colors.js' ), array(), $P9f->version, true );
		}
	}
