...
<form id='designform' method='post' action='<?php echo site_url('index.php/design/admin_design/') ?>'>
	...
	<div class='row'>
		<div class='col-md-12' id='div_design_user'>
			<?php
				if(isset($data['admin_design']))
				{
					foreach((array)$data['admin_design'] as $keys => $values)
					{
...
<script type="text/javascript">
	...
	{
		jQuery('#designform').attr('action', '<?php echo site_url('index.php/design/admin_design/'); ?>' + segment);
		jQuery('#designform').submit();
	}
	function submit_change_perpage()
	{
		jQuery('#designform').attr('action', '<?php echo site_url('index.php/design/admin_design'); ?>');
		jQuery('#designform').submit();
	}
	...
	function submit_delete(segment)
	{
		...
		if(cf)
		{
			jQuery('#designform').attr('action', '<?php echo site_url('index.php/design/admin_delete/'); ?>' + segment);
			jQuery('#designform').submit();
		}
	}
