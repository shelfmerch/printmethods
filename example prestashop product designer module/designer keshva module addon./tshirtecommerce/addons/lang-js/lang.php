...
var lang = {
	...
	rightmenu:{
		edit: '<?php echo lang('designer_edit'); ?>',
		center: '<?php echo lang('designer_center'); ?>',
		send_front: '<?php echo lang('designer_send_layer_front'); ?>',
		send_back: '<?php echo lang('designer_send_layer_back'); ?>',
		select_all: '<?php echo $addons->__('addon_select_all_button_title'); ?>',
	}
}
</script>