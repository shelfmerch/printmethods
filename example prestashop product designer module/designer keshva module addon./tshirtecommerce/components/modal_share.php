			...
			<div class="modal-body">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<span class="copy-status"><?php echo lang('designer_js_copied'); ?></span>
						<span class="input-group-btn">
							<button class="btn btn-default" onclick="design.share.copyURL();" type="button"><?php echo lang('designer_js_copy'); ?></button>
						</span>
					</div>
				</div>
