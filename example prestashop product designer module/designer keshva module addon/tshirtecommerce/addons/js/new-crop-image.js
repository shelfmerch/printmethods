design.tools.crop = {
	...
	wapper: function(){
		...
		jQuery('.mask-items-area').append('<div class="wapper-item-crop"><div class="area-item-crop"></div><span class="bg-item-crop"><div class="dg-options-toolbar" id="crop-toolbar">'+html+'</div></span></div>');
		this.mask();
	},
	mask: function(div){
