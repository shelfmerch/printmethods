...
?>
<div class="modal fade store" id="dg-obj-clipart">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><?php echo lang('designer_clipart_title'); ?></h4>
				<a href="javascript:void(0)" class="close" data-dismiss="modal"><i class="glyph-icon flaticon-cross flaticon-12"></i></a>
			</div>
				...
				<div class="obj-content">
					<div class="obj-tabs tab-content">
						<div class="obj-tab-content tab-pane" id="dg-cliparts">
							...
							<!-- clipart -->
							<div class="dag-art-store main-clipart active obj-main-content">
								<?php
								if($is_store == true){ ?>
