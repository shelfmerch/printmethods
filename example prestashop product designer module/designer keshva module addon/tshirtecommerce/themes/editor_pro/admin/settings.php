...
<div class="tabbable">
	<ul id="myTab" class="nav nav-tabs tab-bricky">
		<li class="active">
			<a href="#panel_tab1" data-toggle="tab"><i class="green fa fa-bars"></i> Layout</a>
		</li>	
		<li>
			<a href="#panel_tab2" data-toggle="tab"><i class="green fa fa-magic"></i> Background & Colors</a>
		</li>
		<li>
			<a href="#panel_tab3" data-toggle="tab"><i class="fa fa-font"></i> Typography</a>
		</li>
		<li>
			<a href="#panel_tab4" data-toggle="tab"><i class="green fa fa-code"></i> Custom CSS & JS</a>
		</li>
	</ul>
