	...
	<div class="main-navigation navbar-collapse collapse">
		<div class="navigation-logo hidden-xs">
			...
			<a class="navbar-brand" href="<?php echo site_url();?>">
				<img src="<?php echo site_url('assets/images/logo.svg'); ?>" height="40" alt="http://tshirtecommerce.com" />
			</a>
		</div>
		...
		<ul class="main-navigation-menu">
			...
			<!-- start: addons -->
			<li <?php if($segments[0] == 'addons_ex') echo 'class="active open"' ?>>
				<a href="javascript:void(0)"><i class="clip-puzzle-4"></i>
					<span class="title"> <?php lang('menu_left_addons'); ?> </span><i class="icon-arrow"></i>
					<span class="selected"></span>
				</a>
				<ul class="sub-menu">
					<li <?php if($segments[0] == 'addons_ex' && isset($segments[1]) && $segments[1] == 'installed') echo 'class="active open"' ?>>
						<a href="<?php echo site_url('index.php/addons_ex/installed'); ?>">
							<span class="title"> <?php lang('menu_left_installed'); ?> </span>
						</a>
					</li>
					<li <?php if($segments[0] == 'addons_ex' && isset($segments[1]) && $segments[1] == 'install') echo 'class="active open"' ?>>
						<a href="<?php echo site_url('index.php/addons_ex/install'); ?>">
							<span class="title"> <?php lang('menu_left_install'); ?> </span>
						</a>
					</li>
					<li <?php if(($segments[0] == 'addons_ex' && empty($segments[1])) || ($segments[0] == 'addons_ex' && isset($segments[1]) && $segments[1] == 'index')) echo 'class="active open"' ?>>
						<a href="<?php echo site_url('index.php/addons_ex'); ?>">
