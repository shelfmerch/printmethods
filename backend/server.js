...
const brandTeamRoutes = require('./routes/brandTeam');
const brandEmployeesRoutes = require('./routes/brandEmployees');
const creditAllocationRoutes = require('./routes/creditAllocation');
const brandSubscriptionRoutes = require('./routes/brandSubscription');
const brandDashboardRoutes = require('./routes/brandDashboard');
const printMethodRoutes = require('./routes/printMethods');
const catalogRoutes = require('./routes/catalog');
const directOrderRoutes = require('./routes/directOrders');
const quotationsRoutes = require('./routes/quotations');
const quotationPdfRoutes = require('./routes/quotationPdf');
const kitsRoutes = require('./routes/kits');
const kitSendsRoutes = require('./routes/kitSends');
const kitRedemptionsRoutes = require('./routes/kitRedemptions');
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    if (isWhitelisted) {
      ...
      callback(new Error('Not allowed by CORS Strictly'));
    }
  },
  credentials: true,
...
app.use('/api/brand-employees', brandEmployeesRoutes);
app.use('/api/credit-allocation', creditAllocationRoutes);
app.use('/api/brand-subscription', brandSubscriptionRoutes);
app.use('/api/brand-dashboard', brandDashboardRoutes);
app.use('/api/print-methods', printMethodRoutes);
app.use('/api/catalog', catalogRoutes);
app.use('/api/direct-orders', directOrderRoutes);
app.use('/api/quotations', quotationsRoutes);
app.use('/api/quotation-pdf', quotationPdfRoutes);
app.use('/api/kits', kitsRoutes);
app.use('/api/kit-sends', kitSendsRoutes);
app.use('/api/kit-redemptions', kitRedemptionsRoutes);
app.use('/api/support-tickets', supportTicketsRoutes);
app.use('/api/admin/direct-orders', require('./routes/adminDirectOrders'));
app.use('/api/admin/kit-fulfillment', require('./routes/adminKitFulfillment'));
